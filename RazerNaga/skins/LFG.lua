...
PVEFrameCloseButton:SetSize(32, 32)
PVEFrameCloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Disabled")
PVEFrameCloseButton:SetNormalTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Up")
PVEFrameCloseButton:SetPushedTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Down")
PVEFrameCloseButton:SetHighlightTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Highlight")
PVEFrameCloseButton:ClearAllPoints()
PVEFrameCloseButton:SetPoint("TOPRIGHT", 5.6, 5)
PVEFrameCloseButton:SetFrameLevel(2)
...
PVEFrame:CreateTexture("PVEFrameTitleBg")
PVEFrame.TitleBg = PVEFrameTitleBg
PVEFrame.TitleBg:SetAtlas("_UI-Frame-TitleTileBg", false)
PVEFrame.TitleBg:SetSize(256, 18)
PVEFrame.TitleBg:SetHorizTile(true)
PVEFrame.TitleBg:ClearAllPoints()
PVEFrame.TitleBg:SetPoint("TOPLEFT", 2, -3)
PVEFrame.TitleBg:SetPoint("TOPRIGHT", -25, -3)

PVEFrame.TopTileStreaks:ClearAllPoints()
PVEFrame.TopTileStreaks:SetPoint("TOPLEFT", 0, -21)
PVEFrame.TopTileStreaks:SetPoint("TOPRIGHT", -2, -21)

ApplyNineSlicePortrait(PVEFrame.NineSlice)
...
if (LFGListFrame.EntryCreation.ActivityFinder.Dialog.ScrollBar.Background == nil) then
	LFGListFrame.EntryCreation.ActivityFinder.Dialog.ScrollBar.Background = LFGListFrame.EntryCreation.ActivityFinder.Dialog.ScrollBar:CreateTexture(nil, "BACKGROUND");
	LFGListFrame.EntryCreation.ActivityFinder.Dialog.ScrollBar.Background:SetColorTexture(0, 0, 0, .65)
	LFGListFrame.EntryCreation.ActivityFinder.Dialog.ScrollBar.Background:SetAllPoints()
end
...
if (LFGListFrame.SearchPanel.ScrollBar.Background == nil) then
	LFGListFrame.SearchPanel.ScrollBar.Background = LFGListFrame.SearchPanel.ScrollBar:CreateTexture(nil, "BACKGROUND");
	LFGListFrame.SearchPanel.ScrollBar.Background:SetColorTexture(0, 0, 0, .65)
	LFGListFrame.SearchPanel.ScrollBar.Background:SetAllPoints()
end
...
LFGListFrame.ApplicationViewer.ScrollBar:SetPoint("BOTTOMLEFT", LFGListFrame.ApplicationViewer.ScrollBox, "BOTTOMRIGHT", 3, -1)

if (LFGListFrame.ApplicationViewer.ScrollBar.Background == nil) then
	LFGListFrame.ApplicationViewer.ScrollBar.Background = LFGListFrame.ApplicationViewer.ScrollBar:CreateTexture(nil, "BACKGROUND");
	LFGListFrame.ApplicationViewer.ScrollBar.Background:SetColorTexture(0, 0, 0, .65)
	LFGListFrame.ApplicationViewer.ScrollBar.Background:SetAllPoints()
end
...
hooksecurefunc("LFG_UpdateAvailableRoleButton", function(button, canBeRole)
	...
	button:GetNormalTexture():SetTexCoord(GetTexCoordsForRole(button.role))
	button:SetDisabledTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
	button:GetDisabledTexture():SetTexCoord(GetTexCoordsForRole(button.role))
