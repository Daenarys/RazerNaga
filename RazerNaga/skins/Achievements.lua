...
f:SetScript("OnEvent", function(self, event, name)
	if name == "Blizzard_AchievementUI" then
		...
		if (AchievementFrameCategories.ScrollBar.Background == nil) then
			AchievementFrameCategories.ScrollBar.Background = AchievementFrameCategories.ScrollBar:CreateTexture(nil, "BACKGROUND");
			AchievementFrameCategories.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			AchievementFrameCategories.ScrollBar.Background:SetAllPoints()
		end
		...
		if (AchievementFrameAchievements.ScrollBar.Background == nil) then
			AchievementFrameAchievements.ScrollBar.Background = AchievementFrameAchievements.ScrollBar:CreateTexture(nil, "BACKGROUND");
			AchievementFrameAchievements.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			AchievementFrameAchievements.ScrollBar.Background:SetAllPoints()
		end
		...
		if (AchievementFrameStats.ScrollBar.Background == nil) then
			AchievementFrameStats.ScrollBar.Background = AchievementFrameStats.ScrollBar:CreateTexture(nil, "BACKGROUND");
			AchievementFrameStats.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			AchievementFrameStats.ScrollBar.Background:SetAllPoints()
		end
...
hooksecurefunc(_G.CriteriaAlertSystem, 'setUpFunction', function(frame)
	frame:SetHeight(52);
