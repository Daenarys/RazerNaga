...
f:SetScript("OnEvent", function(self, event, name)
	if name == "Blizzard_PerksProgram" then
		...
		if (PerksProgramFrame.ProductsFrame.ProductsScrollBoxContainer.ScrollBar.Background == nil) then
			PerksProgramFrame.ProductsFrame.ProductsScrollBoxContainer.ScrollBar.Background = PerksProgramFrame.ProductsFrame.ProductsScrollBoxContainer.ScrollBar:CreateTexture(nil, "BACKGROUND");
			PerksProgramFrame.ProductsFrame.ProductsScrollBoxContainer.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			PerksProgramFrame.ProductsFrame.ProductsScrollBoxContainer.ScrollBar.Background:SetAllPoints()
		end
