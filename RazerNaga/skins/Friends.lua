...
FriendsFrameCloseButton:SetSize(32, 32)
FriendsFrameCloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Disabled")
FriendsFrameCloseButton:SetNormalTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Up")
FriendsFrameCloseButton:SetPushedTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Down")
FriendsFrameCloseButton:SetHighlightTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Highlight")
FriendsFrameCloseButton:ClearAllPoints()
FriendsFrameCloseButton:SetPoint("TOPRIGHT", 5.6, 5)
FriendsFrameCloseButton:SetFrameLevel(2)
...
FriendsFrame:CreateTexture("FriendsFrameTitleBg")
FriendsFrame.TitleBg = FriendsFrameTitleBg
FriendsFrame.TitleBg:SetAtlas("_UI-Frame-TitleTileBg", false)
FriendsFrame.TitleBg:SetSize(256, 18)
FriendsFrame.TitleBg:SetHorizTile(true)
FriendsFrame.TitleBg:ClearAllPoints()
FriendsFrame.TitleBg:SetPoint("TOPLEFT", 2, -3)
FriendsFrame.TitleBg:SetPoint("TOPRIGHT", -25, -3)

FriendsFrame.TopTileStreaks:ClearAllPoints()
FriendsFrame.TopTileStreaks:SetPoint("TOPLEFT", 0, -21)
FriendsFrame.TopTileStreaks:SetPoint("TOPRIGHT", -2, -21)

ApplyNineSlicePortrait(FriendsFrame.NineSlice)
...
if not RaidInfoFrameHeader then
	...
	RaidInfoFrameHeader:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Header")
