...
function Skada:OnInitialize()
	...
	media:Register("font", "Adventure",             [[Interface\Addons\SkadaF\media\fonts\Adventure.ttf]])
	media:Register("font", "ABF",                   [[Interface\Addons\SkadaF\media\fonts\ABF.ttf]])
	media:Register("font", "Vera Serif",            [[Interface\Addons\SkadaF\media\fonts\VeraSe.ttf]])
	media:Register("font", "Diablo",                [[Interface\Addons\SkadaF\media\fonts\Avqest.ttf]])
	media:Register("font", "Accidental Presidency", [[Interface\Addons\SkadaF\media\fonts\Accidental Presidency.ttf]])

	media:Register("statusbar", "Aluminium",        [[Interface\Addons\SkadaF\media\statusbar\Aluminium.tga]])
	media:Register("statusbar", "Armory",           [[Interface\Addons\SkadaF\media\statusbar\Armory.tga]])
	media:Register("statusbar", "BantoBar",         [[Interface\Addons\SkadaF\media\statusbar\BantoBar.tga]])
	media:Register("statusbar", "Glaze2",           [[Interface\Addons\SkadaF\media\statusbar\Glaze2.tga]])
	media:Register("statusbar", "Gloss",            [[Interface\Addons\SkadaF\media\statusbar\Gloss.tga]])
	media:Register("statusbar", "Graphite",         [[Interface\Addons\SkadaF\media\statusbar\Graphite.tga]])
	media:Register("statusbar", "Grid",             [[Interface\Addons\SkadaF\media\statusbar\Grid.tga]])
	media:Register("statusbar", "Healbot",          [[Interface\Addons\SkadaF\media\statusbar\Healbot.tga]])
	media:Register("statusbar", "LiteStep",         [[Interface\Addons\SkadaF\media\statusbar\LiteStep.tga]])
	media:Register("statusbar", "Minimalist",       [[Interface\Addons\SkadaF\media\statusbar\Minimalist.tga]])
	media:Register("statusbar", "Otravi",           [[Interface\Addons\SkadaF\media\statusbar\Otravi.tga]])
	media:Register("statusbar", "Outline",          [[Interface\Addons\SkadaF\media\statusbar\Outline.tga]])
	media:Register("statusbar", "Perl",             [[Interface\Addons\SkadaF\media\statusbar\Perl.tga]])
	media:Register("statusbar", "Smooth",           [[Interface\Addons\SkadaF\media\statusbar\Smooth.tga]])
	media:Register("statusbar", "Round",            [[Interface\Addons\SkadaF\media\statusbar\Round.tga]])
	media:Register("statusbar", "TukTex",           [[Interface\Addons\SkadaF\media\statusbar\normTex.tga]])
	media:Register("statusbar", "CleanSF",          [[Interface\Addons\SkadaF\media\statusbar\Statusbar_Clean]])
	media:Register("border", "Glow",                [[Interface\Addons\SkadaF\media\border\glowTex.tga]])
	media:Register("border", "Roth",                [[Interface\Addons\SkadaF\media\border\roth.tga]])
	media:Register("background", "Copper",          [[Interface\Addons\SkadaF\media\background\copper.tga]])
