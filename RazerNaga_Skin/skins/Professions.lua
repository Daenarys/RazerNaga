...
f:SetScript("OnEvent", function(self, event, name)
	if name == "Blizzard_Professions" then
		ProfessionsFrame.CloseButton:SetSize(32, 32)
		ProfessionsFrame.CloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Disabled")
		ProfessionsFrame.CloseButton:SetNormalTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Up")
		ProfessionsFrame.CloseButton:SetPushedTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Down")
		ProfessionsFrame.CloseButton:SetHighlightTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Highlight")
		ProfessionsFrame.CloseButton:ClearAllPoints()
		ProfessionsFrame.CloseButton:SetPoint("TOPRIGHT", 5.6, 5)
		ProfessionsFrame.CloseButton:SetFrameLevel(2)
		...
		ProfessionsFrame.CraftingPage.TutorialButton.Ring:SetTexture("Interface\\AddOns\\RazerNaga_Skin\\icons\\MiniMap-TrackingBorder.png")

		ProfessionsFrame:CreateTexture("ProfessionsFrameTitleBg")
		ProfessionsFrame.TitleBg = ProfessionsFrameTitleBg
		ProfessionsFrame.TitleBg:SetSize(256, 18)
		ProfessionsFrame.TitleBg:SetAtlas("_UI-Frame-TitleTileBg", false)
		ProfessionsFrame.TitleBg:SetSize(256, 18)
		ProfessionsFrame.TitleBg:SetHorizTile(true)
		ProfessionsFrame.TitleBg:ClearAllPoints()
		ProfessionsFrame.TitleBg:SetPoint("TOPLEFT", 2, -3)
		ProfessionsFrame.TitleBg:SetPoint("TOPRIGHT", -25, -3)

		ProfessionsFrame.TopTileStreaks:ClearAllPoints()
		ProfessionsFrame.TopTileStreaks:SetPoint("TOPLEFT", 0, -21)
		ProfessionsFrame.TopTileStreaks:SetPoint("TOPRIGHT", -2, -21)
		...
		if (ProfessionsFrame.CraftingPage.RecipeList.ScrollBar.Background == nil) then
			ProfessionsFrame.CraftingPage.RecipeList.ScrollBar.Background = ProfessionsFrame.CraftingPage.RecipeList.ScrollBar:CreateTexture(nil, "BACKGROUND");
			ProfessionsFrame.CraftingPage.RecipeList.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			ProfessionsFrame.CraftingPage.RecipeList.ScrollBar.Background:SetAllPoints()
		end
		...
		if (ProfessionsFrame.OrdersPage.BrowseFrame.RecipeList.ScrollBar.Background == nil) then
			ProfessionsFrame.OrdersPage.BrowseFrame.RecipeList.ScrollBar.Background = ProfessionsFrame.OrdersPage.BrowseFrame.RecipeList.ScrollBar:CreateTexture(nil, "BACKGROUND");
			ProfessionsFrame.OrdersPage.BrowseFrame.RecipeList.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			ProfessionsFrame.OrdersPage.BrowseFrame.RecipeList.ScrollBar.Background:SetAllPoints()
		end
		...
		if (ProfessionsFrame.OrdersPage.BrowseFrame.OrderList.ScrollBar.Background == nil) then
			ProfessionsFrame.OrdersPage.BrowseFrame.OrderList.ScrollBar.Background = ProfessionsFrame.OrdersPage.BrowseFrame.OrderList.ScrollBar:CreateTexture(nil, "BACKGROUND");
			ProfessionsFrame.OrdersPage.BrowseFrame.OrderList.ScrollBar.Background:SetColorTexture(0, 0, 0, .85)
			ProfessionsFrame.OrdersPage.BrowseFrame.OrderList.ScrollBar.Background:SetAllPoints()
		end
