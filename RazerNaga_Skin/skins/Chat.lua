...
hooksecurefunc("FCFDock_UpdateTabs", function(dock)
    ...
    QuickJoinToastButton:SetPoint("BOTTOMLEFT", ChatAlertFrame, "BOTTOMLEFT", 0, -23)
end)

ChatConfigFrame.Header.LeftBG:SetSize(32, 41)
ChatConfigFrame.Header.LeftBG:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Header")
ChatConfigFrame.Header.LeftBG:SetTexCoord(0.22265625, 0.34375, 0, 0.640625)

ChatConfigFrame.Header.CenterBG:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Header")
ChatConfigFrame.Header.CenterBG:SetTexCoord(0.34375, 0.65234375, 0, 0.640625)
ChatConfigFrame.Header.CenterBG:SetHorizTile(false)

ChatConfigFrame.Header.RightBG:SetSize(32, 41)
ChatConfigFrame.Header.RightBG:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Header")
ChatConfigFrame.Header.RightBG:SetTexCoord(0.65234375, 0.77734375, 0, 0.640625)
