...
function CfRuneButtonMixin:OnEnter()
...
function CfRuneFrameMixin:OnEvent(event, ...)
...
function CfRuneFrameMixin:IsAnimatingRunesSpent()
	return self.spentAnimsActive > 0;
end

function CfRuneFrameMixin:OnSpentAnimStarted()
	self.spentAnimsActive = self.spentAnimsActive + 1;
end

function CfRuneFrameMixin:OnSpentAnimStopped()
	self.spentAnimsActive = self.spentAnimsActive - 1;
