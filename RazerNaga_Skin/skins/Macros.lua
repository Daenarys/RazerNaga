...
f:SetScript("OnEvent", function(self, event, name)
	if name == "Blizzard_MacroUI" then
		MacroFrameCloseButton:SetSize(32, 32)
		MacroFrameCloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Disabled")
		MacroFrameCloseButton:SetNormalTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Up")
		MacroFrameCloseButton:SetPushedTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Down")
		MacroFrameCloseButton:SetHighlightTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Highlight")
		MacroFrameCloseButton:ClearAllPoints()
		MacroFrameCloseButton:SetPoint("TOPRIGHT", 5.6, 5)
		MacroFrameCloseButton:SetFrameLevel(2)
		...
		MacroFrame:CreateTexture("MacroFrameTitleBg")
		MacroFrame.TitleBg = MacroFrameTitleBg
		MacroFrame.TitleBg:SetAtlas("_UI-Frame-TitleTileBg", false)
		MacroFrame.TitleBg:SetSize(256, 18)
		MacroFrame.TitleBg:SetHorizTile(true)
		MacroFrame.TitleBg:ClearAllPoints()
		MacroFrame.TitleBg:SetPoint("TOPLEFT", 2, -3)
		MacroFrame.TitleBg:SetPoint("TOPRIGHT", -25, -3)

		MacroFrame.TopTileStreaks:ClearAllPoints()
		MacroFrame.TopTileStreaks:SetPoint("TOPLEFT", 0, -21)
		MacroFrame.TopTileStreaks:SetPoint("TOPRIGHT", -2, -21)

		ApplyNineSlicePortrait(MacroFrame.NineSlice)
